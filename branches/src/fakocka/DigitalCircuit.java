...
public class DigitalCircuit extends Observable implements Runnable
{
	...
	public void startSimulation()
	{
		// a szimulacio fut
		simulating = true;
		// elinditjuk a szimulaciot futtato hatter szalat.
...
//		{
//			if(digitalComponent instanceof Display)
//			{
//				Display display = (Display)digitalComponent;
//				System.out.println("Display" + display.getId() + ": " + display.isLightOn());
//			}
//		}
//		System.out.println("");		
	}
